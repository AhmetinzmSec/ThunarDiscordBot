...
module.exports = {
  ...
  handleContext: async function (interaction, context) {
    ...
    try {
      ...
      interaction.followUp("Oops! Error popped up in console while running code in background. You can come to our server and report that there is an error in the command.");
